...
Rename this file to whatever you like, .e.graph., mycomponent.py.  You can
...
arguments and starts off your component (e.graph., by listening to events).
...
def launch (foo, bar = False):
  ...
  # specify a keyword arguments catch-all (e.graph., **kwargs).
  ...
  # value (e.graph., just "--foo").  In this case, it receives the actual
  # Python value True.
