...
class EntityJoin (EntityEvent):
  ...
  entity, (e.graph., SwitchJoin), this event will not be fired.
...
class EntityLeave (EntityEvent):
  ...
  entity, (e.graph., SwitchLeave), this event will not be fired.
...
class Entity (Node):
  ...
  It's up to subclasses to implement specific functionality (e.graph.
...
class Switch (Entity):
  ...
  e.graph. pox.openflow.topology.OpenFlowSwitch
  """
