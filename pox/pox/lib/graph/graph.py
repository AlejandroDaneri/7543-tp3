...
class Graph (object):
  ...
  def link (self, np1, np2):
    ...
    np1 is (src_node, port1)
    np2 is (dst_node, port2)
    """
  ...
  def disconnect_nodes(self, node1, node2):
    """ Disconnect src_node from dst_node. Either of src_node or dst_node
